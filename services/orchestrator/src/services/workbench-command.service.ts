...
import { releaseExecutionWorkspace as runReleaseExecutionWorkspace } from "./workbench-release-workspace";
...
export {
  ...
  clearActiveReleaseTokens,
} from "./workbench-release-workspace";
...
export class WorkbenchCommandService {
  ...
  async releaseExecutionWorkspace(input: {
    ...
    return runReleaseExecutionWorkspace(
      {
        dataSource: this.dataSource,
        workspaceExecutions: this.workspaceExecutions,
        boundedKey: (key) => this.boundedKey(key),
