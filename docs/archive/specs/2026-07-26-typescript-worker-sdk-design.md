---
title: TypeScript Worker SDK Design
status: historical
...
> Historical record. This design reflects the pre-Tenvyr internal naming and is not the current API or package reference.
