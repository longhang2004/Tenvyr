---
title: TypeScript Worker SDK Implementation Plan
status: historical
...
> Historical record. This plan reflects the pre-Tenvyr internal naming and is not the current API or package reference.
