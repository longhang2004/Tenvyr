...
The change is deliberately limited to message contracts. Kafka remains the invocation
transport; topic names, agent names, the pipeline DAG, the Java Agent Runner HTTP API, and
the database schema are unchanged.
