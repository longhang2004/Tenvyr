...
3. Read these durable roadmap files:
   - docs/plans/active/tenvyr-roadmap/ROADMAP.md
   - docs/plans/active/tenvyr-roadmap/EXECUTION_STATUS.md
   - docs/plans/active/tenvyr-roadmap/EXTERNAL_PRODUCTION_EXPOSURE_GATE.md
   - docs/plans/active/tenvyr-roadmap/RESEARCH_REGISTER.md
...
D. Record progress
- Update docs/plans/active/tenvyr-roadmap/EXECUTION_STATUS.md with one compact row:
