...
preserve the implementation evidence. M3 is the first ready milestone.
...
| M3 executors/runtimes   | READY   | [M3 plan](M3-executors-providers/PLAN.md)                                                   | independently closed M2       |
| M4 policy/budgets       | BLOCKED | [M4 plan](M4-policy-budgets/PLAN.md)                                                        | M2; action policy also M3     |
| M5 dynamic planner      | BLOCKED | [M5 plan](M5-dynamic-planner/PLAN.md)                                                       | M2, M4 enforcement foundation |
| M6 delegation/subagents | BLOCKED | [M6 plan](M6-delegation-subagents/PLAN.md)                                                  | M3, M4, M5                    |
| M7 capsule/replay       | BLOCKED | [M7 plan](M7-execution-capsule/PLAN.md)                                                     | M2–M6 evidence                |
