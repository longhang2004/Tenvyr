...
sources:
  ...
  - docs/plans/active/tenvyr-productization-roadmap/P3-runtime-harness-optimization/SPEC.md
  - docs/plans/active/tenvyr-productization-roadmap/P3-runtime-harness-optimization/VERIFY.md
---
