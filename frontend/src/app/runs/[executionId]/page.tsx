...
import { LoopTab } from "./LoopTab.tsx";
import { EvidenceTab } from "./EvidenceTab.tsx";
import { CapsuleTab } from "./CapsuleTab.tsx";
import { EfficiencyTab } from "./EfficiencyTab.tsx";
...
export default function RunDetailPage() {
  ...
  return (
    <div className="page-container">
      ...
      {activeTab === "loop" && <LoopTab iterations={iterations} />}
      ...
      {activeTab === "capsule" && <CapsuleTab capsule={capsule} />}
      ...
      {activeTab === "efficiency" && (
        <EfficiencyTab
          efficiencyAggregate={efficiencyAggregate}
          attempts={attempts}
        />
      )}
    </div>
