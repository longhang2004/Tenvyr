        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Framework-Neutral Execution Control Plane
              </span>
            </div>
            ...
            >
              Tenvyr owns contracts, dispatch, supervision, policy, and durable
              orchestration without replacing your agent framework.
              Observability is a projection of execution, not the product
              boundary.
            </p>
          ...
          >
            ...
            >
              <div style={{ color: "var(--accent-blue)" }}>
                [00:01:23] Kafka consumer connected to topic:
                agentweave.agent.observability.task
              </div>
              <div style={{ animation: "logProgress 4s infinite" }}>
                [00:01:24] Dispatching task with input context...
              </div>
            </div>
          </div>
        </section>
        ...
        >
          ...
          >
            ...
            <p style={{ color: "var(--text-secondary)" }}>
              A control plane outside agent processes in 3 clear steps
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              <p style={{ color: "var(--text-secondary)", fontSize: "0.9rem" }}>
                Write declarative YAML files specifying step execution orders,
                conditions, custom input parameters, and failure recovery
                options.
              </p>
            </div>
            ...
            >
              ...
              <p style={{ color: "var(--text-secondary)", fontSize: "0.9rem" }}>
                Keep agents in any language or framework. Tenvyr dispatches work
                over stable contracts and supervises the execution lifecycle.
              </p>
            </div>
            ...
            >
              ...
              <p style={{ color: "var(--text-secondary)", fontSize: "0.9rem" }}>
                Inspect live execution flows, outcomes, and provenance.
                Telemetry remains a projection of the durable orchestration
                state.
              </p>
            </div>
          </div>
